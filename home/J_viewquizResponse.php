   ...
   <body class="main-layout inner_page" background="../home/images/p8.png">
      ...
      <?php
         ...
         $sql = "Select q.question,
                        ...
                        r.response
                        from quiz q
                  Join quizresponse r on q.quizID=r.quizID
                        where r.participantID = $id;
                        ";
         $result = mysqli_query($conn,$sql);
         if(mysqli_num_rows($result)>0){
            echo "<table>
            <tr><th style = 'color : black'>Question</th>
            <th style = 'color : black'>Participant Response</th>
            <th style = 'color : black'>Correct Answer</th>
            </tr>";
            while ($row = mysqli_fetch_assoc($result)){
               echo "<tr><td><b>".$row['question']."</b></td>";
               echo "<td><b>".$row['response']."</b></td>";
               echo "<td><b>".$row['correctOption']."</b></td></tr>";   
            }
         }
    ...
    <form method="post" action="J_quizresult.php">
      <input type="hidden" name="id" value="<?php echo $id; ?>">
      <label for="Score" ><b>Score : </b></label>
      <input type="number" id="score" name="score" max="20" required >
      <label for="Outoff"><b>Outoff : </b></label>
      <input type="number" id="outoff" name="outoff" value= 20 required >
      <button type="submit" class="submit-button" name="submit" style="background-color : darkorange"><b>Submit Marks</b></button>
    </form>
    </div><br>
      <!-- footer -->
