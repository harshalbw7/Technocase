     ...
     <div class="schedule">
        <div class="container">
           <div class="row">
              <div class="col-md-12">
                 <div class="titlepage text_align_center">
                 <h2>CASE STUDY RESPONSE</h2><br><br>
                 </div>
              </div>
           </div>
        </div>
           ...
           <div class="row">
              <div class="col-md-12">
                 ...
                 <?php
                        ...
                        $sql = "SELECT distinct(participant.name) FROM casestudyresponse
                        JOIN participant on casestudyresponse.participantID = participant.participantID";
                        $result = $conn->query($sql);

                        // Display the form with dropdown options
                        echo "<form action='J_viewCaseResponse.php' method='post'>";
                        echo "<select id='partname' name='partname'>";

                        while ($row = $result->fetch_assoc()) {
                            echo "<h2><option  value='" .$row['name']. "'>".$row['name']."</option></h2>";
                        }
                        echo "</select>";
