   ...
   <body class="main-layout inner_page" background="../home/images/p8.png">
      ...
      <div class="schdule">
        <div class="text_align_center">
            <h2 style='font-size : xxx-large'><b>CASESTUDY RESULT RANKING</b></h2>
        </div><br>
      <?php
            $conn = mysqli_connect('localhost', 'root', '', 'technocase');
            $query="select P.name,P.course,P.college,R.eventType,R.percent from participant P JOIN result R ON P.participantID = R.participantID where R.eventType = 'CaseStudy' order by R.percent DESC";
