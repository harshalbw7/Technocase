   ...
   <body class="main-layout inner_page" background="../home/images/p8.png">
      ...
      <div class="kabout">
        <div class="container">
           <div class="row">
              <div class="col-md-12">
                 <div class="titlepage text_align_center" style="font-weight: bolder; font-size:x-large;">
                    <form role="form" action="../php resource/P_feedback.php" method="post">
                               <div class="form-row">
                                   <div class="form-group col-md-12">
                                       <label for="sname">Participant Name</label> <input type="text" value="<?php echo $name ?>"
                               ...
                               <div class="form-row">
                                   <div class="form-group col-md-12">
                                       <label for="review">How do you feel about our TECHNOCASE event ?</label><br> 
                                        <input type="radio" name="review" value="Good event">Good event
                                        <input type="radio" name="review" value="Better event">Better event
                                        <input type="radio" name="review" value="Best event">Best event 
                                   </div>
                               </div>
                               <div class="form-row">
                                   <div class="form-group col-md-12">
                               ...
                               <div class="form-row">
                                   <div class="form-group col-md-12">
                                       <button type="submit" value="submit" name="submit" class="btn btn-info" id="btnValidate">Submit Feedback</button>
                                       <button type="reset" class="btn btn-danger" id="btnValidate">Clear</button>
                                   </div>
                               </div>
                           </form>
                 </div>
