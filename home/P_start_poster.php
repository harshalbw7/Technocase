...
$sql = "select * from poster order by rand() limit 1";
       ...
       <div class="schedule text_align_center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>POSTER COMPETITION</h2></div>
                        <div>
                        <div class="panel-heading"><h1><b>POSTER INSTRUCTION</b></h1></div><br><br>
                        <ul>
                        <h2> 
                           <h3><li>participants are allowed to revise and resubmit their poster solutions before the deadline.</li><br>
                           <li>Require participants to use a specific font type, size, and formatting style for their graphical submissions.</li><br>
                           <li>Total time for the poster competition is 30 Minutes.</li><br>
            ...
            <?php
               ...
               if ($_SERVER["REQUEST_METHOD"] == "POST") {
                  ...
                  $sql = "insert into posterresponse (participantID,question,fname) values($participantID,'$random_question','$name')";
