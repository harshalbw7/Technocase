               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="panel panel-primary">
                     ...
                     <div class=" text_align_center">
                        <div class="panel-heading"><h1><b>QUIZ INSTRUCTION</b></h1></div><br><br>
                        <ul>
                        <h2><li>All questions are compulsory.</li><br>
                           <h2><li>Quiz contains Multiple Choice Questions.</li><br> 
                           <li>Each correct answer contains 4 marks.</li><br>
                           <li>Total time for the Quiz is 5 Minutes.</li><br>
                           <li>You can finish the exam at any time.</li><br>
                           <li>Read the question carefully before answering.</li><br>
                           <li>You can change your answers before submitting.</li><br>
                           <li>Good luck for the test.</li></ul></h2>
                           <br>
                           <a href="P_start_quiz.php" class="btn btn-primary">Start Quiz</a>
                        </ul>
