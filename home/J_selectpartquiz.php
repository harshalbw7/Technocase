           ...
           <div class="row">
              <div class="col-md-12">
                 ...
                 <?php
                        ...
                        $sql = "SELECT distinct(participant.name) FROM quizresponse
                        JOIN participant on quizresponse.participantID = participant.participantID";
                        $result = $conn->query($sql);

                        // Display the form with dropdown options
                        echo "<form action='J_viewquizResponse.php' method='post'>";
